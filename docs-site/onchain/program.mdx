...
Status marks follow `progress.md`: ✅ exercised (localnet integration tests, 8/8; core
lifecycle also exercised on devnet) · 🔴 typed stub returning `NotImplemented`.
...
### `combo_accept(quote, taker_sig)` 🔴 · `resolve_combo()` 🔴

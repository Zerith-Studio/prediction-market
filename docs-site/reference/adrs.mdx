...
| [0007](https://github.com/Zerith-Studio/prediction-market/blob/main/docs/adr/0007-scope-team-schedule.md) | Scope / team / schedule | 2 engineers, greenfield Anchor, two parallel tracks joined by the frozen interface contract; hard cut order; the binary trust-core is the never-cut hill. |
...
(0006). Two engineers built it on two parallel tracks with a hard mid-point cut line
(0007).

## Companions

- [`docs/interface-contract.md`](https://github.com/Zerith-Studio/prediction-market/blob/main/docs/interface-contract.md) — the frozen E1↔E2 build boundary.
...
- [`docs/HANDOFF.md`](https://github.com/Zerith-Studio/prediction-market/blob/main/docs/HANDOFF.md) — runbooks, invariants, punch list.
- [`PROJECT_PLAN.md`](https://github.com/Zerith-Studio/prediction-market/blob/main/PROJECT_PLAN.md) — the execution plan and schedule.

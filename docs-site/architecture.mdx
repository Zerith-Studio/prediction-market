---
title: "Architecture"
description: "The Anchor settlement program and the Go engine + crank + clients, joined by a frozen interface contract."
---

PitchMarket is split into two components that meet at a frozen boundary document,
...
## The Anchor settlement program (`programs/pitchmarket/`)
